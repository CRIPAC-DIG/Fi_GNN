...
class FiGNN():
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():
            ...
            self.GNN_layers = self.blocks - 1  # the first layer is multihead-attention layer.
            self.y_deep, self.y_deeps = GNN(
                self.y_deep, self.block_shape, self.GNN_layers, self.output_size, self.field_size)
