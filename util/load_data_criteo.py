...
attribute_list = [u'site_id', u'C20', u'C19', u'site_domain', u'device_type',
...
class Loader(object):
    def __init__(self, flag):
        if platform.system() == 'Linux':
            ...
            self.path_file = path_file = './data/criteo/'
    ...
    def change_data_list(self, idx):
        ...
        # valid_idx: [0-9]
        if idx < 10:
            trainfile_name = 'train_0' + str(int(idx)) + '.json'
        else:
            trainfile_name = 'train_' + str(int(idx)) + '.json'
        # the valid dataset is randomply selected.
        # validfile_name = 'valid_' + str(np.random.randint(10)) + '.json'
        validfile_name = 'valid_' + str(int(idx / 10)) + '.json'
